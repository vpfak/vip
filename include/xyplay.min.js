/*!
 * Xyplayer.js v3.9
 * (c) 2014-2019  xymov.net
 * Released under the Commercial License.
 */
 /* global opera, java, Base64, _GET*/
  ...
  !function (global, factory) {
    ...
    xyplayer.prototype = {
        ...
        init: function (c) {
           ...
           //设置播放标志
            ...
            switch (this.tp) {
                ...
                case 'id':   
                try {
                    var xyplay = new Function('return parent.' + this.variable)();
                    $(this.logo).hide();
            ...
            switch (code) {
                ...
                case 5:
                    ...
                    if ("undefined" !== typeof data.player && data.player !== "") {
                     ...
                     //调用播放
                    if(this.lsplay('play', data.url) || this.onflag === 'list'){
                ...
                default:
                    try {
                        if ($this.onflag == 'line') {
                            var time = Number($this.jxtime)
                        } else {
                            var time = 0;
                        }
                        setTimeout(function () { $this.loadtime(true); }, time * 1000);
                    } catch (e) {
        ...
        GetPlayParm: function () {
            $.ajax({
                url: $this.api + '?tp=getparm&referer' + document.referer,
                dataType: 'jsonp',
                jsonp: 'cb',
           ...
           // $(document).ready(function () { $(document).bind("contextmenu", function (e) { return false; });});
            ...
            $(document).on('click', '.click_work', function () {
                ...
                if (type === "line") {
                    ...
                    if($this.lsplay('play',url)){$this.AutoPlay('list',url);}else{$this.AutoPlay('line',url);}
                    if ($this.lswap) {
                        $($this.plist).hide();
                    }else{
                        $this.replaylist();
        ...
        testplay: function (type, url, play) {
            ...
            switch (type) {
                ...
                case 'url':
                    ...
                    if (urljmp !== '') {
                        this.onflag = 'auto';
                        this.farme(this.player, urljmp + url, this.success);
                ...
                case 'flag':
                    ...
                    if (flagjmp !== '') {
                        this.onflag = 'auto';
                        this.farme(this.player, flagjmp + url, this.success);
        ...
        AutoPlay: function (type, url, play) {
            ...
            switch (type) {
                ...
                //来自线路列表
                case 'line':
                    url = url || this.url || this.playlist_array[this.part] ;
        ...
        jxplay: function (num, word, nosave) {
            word = word || this.url;  if(word==''){$this.loadtime(true);return;}
            num = num || this.myurl;
            nosave = nosave || false;
       ...
       open:function(url){
        ...
        /*   内部函数：输出 高亮调试信息  */
        onVer: function () {
            var message = "XyPlayer X3 by http://nohacks.cn";
            if (typeof console === 'object') {
                console.log("\n %c XyPlayer X3 %c http://nohacks.cn \n\n", "color: #fadfa3; background: #030307; padding:5px 0;", "background: #fadfa3; padding:5px 0;");
